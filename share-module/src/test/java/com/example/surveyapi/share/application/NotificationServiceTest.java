package com.example.surveyapi.share.application;
...
import com.example.surveyapi.share.application.client.ShareValidationResponse;
import com.example.surveyapi.share.application.notification.NotificationSendService;
import com.example.surveyapi.share.application.notification.NotificationService;
import com.example.surveyapi.share.application.notification.dto.NotificationResponse;
...
class NotificationServiceTest {
	...
	void send_success() {
		...
		verify(notificationSendService).send(notification);
	}
	...
	@Test
	@DisplayName("알림 조회 - SENT 상태 변경 체크")
	void getMyNotification_success() {
		...
		String email = "email";
		ReflectionTestUtils.setField(notification, "status", Status.SENT);
