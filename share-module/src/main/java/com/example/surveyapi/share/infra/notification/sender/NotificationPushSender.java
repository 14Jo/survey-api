...
public class NotificationPushSender implements NotificationSender {
	...
	static {
		...
		pushContentMap.put(ShareSourceType.PROJECT_MANAGER, new PushContent(
			"회원님께서 프로젝트 관리자로 등록되었습니다.", "회원님께서 프로젝트 관리자로 등록되었습니다."));
		pushContentMap.put(ShareSourceType.PROJECT_MEMBER, new PushContent(
			"회원님게서 프로젝트 대상자로 등록되었습니다.", "회원님께서 프로젝트 대상자로 등록되었습니다."));
		pushContentMap.put(ShareSourceType.SURVEY, new PushContent(
