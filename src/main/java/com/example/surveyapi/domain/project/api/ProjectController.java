...
public class ProjectController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse<Long>> create(@RequestBody @Valid CreateProjectRequest request) {
		Long currentMemberId = 1L; // TODO: 시큐리티 구현 시 변경
		Long projectId = projectService.create(request, currentMemberId);
