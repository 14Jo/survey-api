...
@Getter
public class QuestionCreationInfo {
	...
	public QuestionCreationInfo(String content, QuestionType questionType, boolean isRequired, int displayOrder, List<ChoiceInfo> choices) {
