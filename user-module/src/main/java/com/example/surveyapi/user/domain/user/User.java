...
import com.example.surveyapi.user.domain.auth.Auth;
import com.example.surveyapi.user.domain.auth.enums.Provider;
import com.example.surveyapi.user.domain.demographics.Demographics;
...
import com.example.surveyapi.user.domain.user.event.UserEvent;
import com.example.surveyapi.user.domain.demographics.vo.Address;
import com.example.surveyapi.user.domain.user.vo.Profile;
